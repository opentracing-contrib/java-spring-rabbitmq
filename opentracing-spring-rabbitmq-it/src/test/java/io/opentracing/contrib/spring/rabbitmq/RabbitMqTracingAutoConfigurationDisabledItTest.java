...
/**
 * Test tracing with default auto-configuration and disabled via flag.
 * @author Ats Uiboupin
 * @author Gilles Robert
 */
@SpringBootTest(
    webEnvironment = SpringBootTest.WebEnvironment.NONE,
    classes = RabbitMqTracingAutoConfigurationItTest.TestConfig.class, // reuse auto-configuration test config from another test, ...
